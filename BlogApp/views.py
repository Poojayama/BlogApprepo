...
#send_mail('Hello', 'Very imp msg....', 'yamapoojitha2002@gmail.com', ['billanasaraiah808@gmail.com', 'podagatlakavya@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'yamapoojitha2002@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
        form=EmailSendForm()
